...
class AuthorizationTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     */
    public function it_returns_an_authorization_response()
    {
        $authorizationRequest = new AuthorizationRequest($this->httpClient, $this->gateway, $this->data);
        $this->assertInstanceOf(AuthorizationResponse::class, $authorizationRequest->response());
    }
}
